...
class GeneralPurposeAgent:
    ...
    async def handle_request(self, deployment_name: str, choice: Choice, request: Request, response: Response) -> Message:
        ...
        async_dial_client = AsyncDial(base_url=self.endpoint, api_key=request.api_key, api_version=request.api_version)
        ...
        #    - deployment_name
        #    - make it stream
        chunks = async_dial_client.chat.completions.create(
    ...
    def _prepare_messages(self, messages: list[Message]) -> list[dict[str, Any]]:
        ...
        print("History of messages for LLM:")
