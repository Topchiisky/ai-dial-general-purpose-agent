...
class ImageGenerationTool(DeploymentTool):
    ...
    def description(self) -> str:
        ...
        return ("Generates images based on detailed textual descriptions. "
                "Use this tool when the user requests image creation from text prompts, such as 'Create an image of a sunset over a mountain range' or 'Generate a picture of a futuristic cityscape'. "
                "Don't use it when: user wants to edit existing images, needs image recognition, or is asking for non-visual content. "
                "HOW IT WORKS: Takes a detailed text description as input and produces a corresponding image. The more specific the prompt, the better the generated image will match the user's request.")
    @property
